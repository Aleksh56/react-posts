...
const Header = () => {
  ...
  return (
    <header className='bg-blue-300 px-4 py-3'>
      <div className='container mx-auto flex items-center justify-center gap-5 md:gap-0 md:justify-between flex-col py-4 w-full md:flex-row'>
        <div className='header__logo flex items-center justify-center w-full'>
